...
function createUser($username, $password, $role)
{
    ...
    $existingUserQuery = "SELECT id_user FROM account WHERE username = '$username'";
    ...
    $query = "INSERT INTO account (username, password, role) VALUES ('$username', '$hashedPassword', '$role')";
